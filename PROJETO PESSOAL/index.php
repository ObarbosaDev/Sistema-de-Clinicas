	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        ...
	        <li class="nav-item">
	          <a class="nav-link" href="?page=relatorio-consultas">Relatório de Consultas</a>
	        </li>
	        <li class="nav-item">
	          <a class="nav-link" href="?page=agenda-diaria">Agenda Diária</a>
	        </li>
	        
	        <!-- Adicionando Calendário -->
	        <li class="nav-item">
	          <a class="nav-link" href="?page=calendario-disponibilidade">Calendário de Disponibilidade</a>
	        </li>
	      </ul>
			...
			<div class="col">
				<?php
					...
					switch (@$_REQUEST['page']) {
						...
						case 'relatorio-consultas':
							include('relatorio-consultas.php');
							break;

						case 'agenda-diaria':
							include('agenda-diaria.php');
							break;

						case 'calendario-disponibilidade': // Novo case
							include('calendario-disponibilidade.php');
							break;
						
						default:
							echo "<h1>Bem-vindo ao Sistema de Controle Clínico</h1>";
					}
				?>
			</div>
		</div>
